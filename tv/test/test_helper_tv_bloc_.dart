...
class NowPlayingTvSeriesBlocHelper
    extends MockBloc<TvSeriesEventBloc, TvSeriesStateBloc>
    implements OnAiringTvBloc {}
...
class PopularTvSeriesBlocHelper
    extends MockBloc<TvSeriesEventBloc, TvSeriesStateBloc>
    implements PopularTvSeriesBloc {}

class TopRatedTvSeriesEventBlocHelper extends Fake
    implements TvSeriesEventBloc {}

class TopRatedTvSeriesStateHelper extends Fake implements TvSeriesStateBloc {}

class TopRatedTvSeriesBlocHelper
    extends MockBloc<TvSeriesEventBloc, TvSeriesStateBloc>
...
class TvSeriesDetailBlocHelper
    extends MockBloc<TvSeriesEventBloc, TvSeriesStateBloc>
    implements TvSeriesDetailBloc {}

class TvSeriesRecommendationEventBlocHelper extends Fake
    implements TvSeriesEventBloc {}

class TvSeriesRecommendationStateHelper extends Fake
    implements TvSeriesStateBloc {}

class TvSeriesRecommendationBlocHelper
    extends MockBloc<TvSeriesEventBloc, TvSeriesStateBloc>
    implements TvSeriesRecommendationBloc {}

class WatchlistTvSeriesEventBlocHelper extends Fake
    implements TvSeriesEventBloc {}

class WatchlistTvSeriesStateHelper extends Fake implements TvSeriesStateBloc {}

class WatchlistTvSeriesBlocHelper
    extends MockBloc<TvSeriesEventBloc, TvSeriesStateBloc>
