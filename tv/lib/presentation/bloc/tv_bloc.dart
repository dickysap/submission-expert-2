...
class OnAiringTvBloc extends Bloc<TvSeriesEventBloc, TvSeriesStateBloc> {
  final GetOnAiringTv _getNowPlayingTvSeries;

  OnAiringTvBloc(this._getNowPlayingTvSeries) : super(TvSeriesLoading()) {
...
class TvSeriesDetailBloc extends Bloc<TvSeriesEventBloc, TvSeriesStateBloc> {
  final GetTvDetailail _getTvSeriesDetail;
...
class TvSeriesRecommendationBloc
    extends Bloc<TvSeriesEventBloc, TvSeriesStateBloc> {
...
class SearchTvSeriesBloc
    extends Bloc<SearchEventTvSeries, SearchStateTvSeries> {
